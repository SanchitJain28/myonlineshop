    ...
    <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
            ...
            {product.images.map((image, index) => (
              <button
                ...
                className={`relative h-20 w-20 rounded-md overflow-hidden border-2 ${
                  currentImage === index ? "border-rose-500" : "border-transparent"
                }`}
              >to
                <img
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-6 leading-relaxed text-gray-700">{product.productDescription
          }</p>
          ...
          <button className="flex items-center justify-center gap-2 px-6 py-3 mt-8 font-medium text-white transition-colors rounded-md bg-rose-600 hover:bg-rose-700">
